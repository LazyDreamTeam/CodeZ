...
INSERT INTO `category` VALUES (1,'PHP',NULL,18,NULL,''),(2,'CSS',NULL,18,NULL,''),(6,'truc','',18,NULL,'');
...
CREATE TABLE `user` (
  ...
  `state` varchar(40) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='utf8_general_ci';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (18,'AkaiKen',NULL,'akaiken@lamecarlate.net','5f44e9580c3fd594266afa3671f55969908c0190','',NULL,'2012-09-17 18:38:22','e47b8e660308ab0d1bc3f28a8bbb9fbe5723ba45','active');
...
-- Dump completed on 2012-10-14 15:13:32
